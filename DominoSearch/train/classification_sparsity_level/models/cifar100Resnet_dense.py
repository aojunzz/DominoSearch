...
__all__ = ['resnet20_cifar_dense', 'resnet32_cifar_dense', 'resnet44_cifar_dense', 'resnet56_cifar_dense',
           'resnet110_cifar_dense']
...
def resnet20_cifar_dense(**kwargs):
    model = ResNet(20,  **kwargs)
    return model


def resnet32_cifar_dense(**kwargs):
    model = ResNet(32, **kwargs)
    return model


def resnet44_cifar_dense(**kwargs):
    model = ResNet(44,  **kwargs)
    return model


def resnet56_cifar_dense(**kwargs):
    model = ResNet(56, **kwargs)
    return model


def resnet110_cifar_dense(**kwargs):
